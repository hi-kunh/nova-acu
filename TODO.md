...
- **▶ 이번 주 일정 (2026-09-15 화 ~ 09-18 금)** — 9/14 저녁에 다시 세움
  ...
  **원시 바이트와 Object 번호가 전부 확정**돼, 이번 주는 **조회 명령 구현**이 중심이 된다.
  ...
  | **9/18 (금)** ✅ | **⑤ 남은 조회 명령** — `0x2b`(43) 컨트롤러 장치 · `0x2f`(47) 카드리더 · `0x51~0x54` 알람/스케줄 3종 | ✅ **9/15에 앞당겨 완료** — 주소는 **실제 DM 트래픽**에서, 크기는 SDK에서(캡처 3개와 일치 확인). `tools/setting_all_test.py`.<br>보드 배포 후 Platinum 「장치 정보 업데이트」 재확인 필요 |
